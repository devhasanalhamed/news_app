    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `article_table` (`id` INTEGER, `source` TEXT, `author` TEXT, `title` TEXT, `description` TEXT, `url` TEXT, `urlToImage` TEXT, `publishedAt` TEXT, `content` TEXT, PRIMARY KEY (`id`))');
...
class _$ArticleDao extends ArticleDao {
  ...
  Future<List<Article>> getAllArticles() async {
    return _queryAdapter.queryList('SELECT * From article_table',
